...
import { Crown, FileText, Hamburger } from "lucide-react";
...
export default function Navbar({ plan }: { plan: String }) {
          ...
          <SignedIn>
            <>
              ...
              <Badge
                ...
                className={cn(
                  "text-sm ml-3 bg-linear-to-r from-amber-100 via-amber-200 to-amber-300 lg-flex flex-row items-center",
                  "cursor-pointer",
                )}
              >
